...
def main():
    ...
    parser.add_argument("--fold", type=int, default=0, help="Fold index (0‑4). Use 0 for a quick test.")
    parser.add_argument("--epochs", type=int, default=500, help="Number of training epochs.")
    parser.add_argument("--device", choices=["cuda", "mps", "cpu"], help="Force a specific device.")
    parser.add_argument("--plan", action="store_true", help="Only run the planning step and exit.")
